<template>
    <div class="container q-pa-xl">
        ...
        <div class="font row justify-center text-center">
            <div v-for="(car, index) of this.motorcars" :key='index' class="col-10 col-sm-5 col-md-3 q-ma-md"
                :class="'car' + index">
        ...
        <div class="font row justify-center text-center">
            <div v-for="(cycle, index) of this.motorcycles" :key='index' class="col-10 col-sm-5 col-md-3 q-ma-md"
                :class="'cycle' + index">
